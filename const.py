USERS_IN_LOCATION: int = 20
BUY_VIP: bool = False
USER_RATING_COUNT: int = 10
BUY_ROOM: bool = True
RESTORE_ENERGY: bool = True

AWARDS: tuple = ("vip", "crafter", "magnate", "generous", 
                 "pilowChamp", "workaholic", "goodFriend", 
                 "shopaholic", "beachRaceChamp", "schoolMaster")
...
NEW_ROOM = [
    {"tpid": "wall15", "d": 3, "lid": 1, "x": 0.0, "y": 0.0, "z": 0.0},
